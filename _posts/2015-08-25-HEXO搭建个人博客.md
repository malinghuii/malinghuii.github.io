...
翻到最下面，改成我这样子的，注意： `: 后面要有空格`
	...
	deploy:
	  type: git
	  repository: https://github.com/malinghuii/malinghuii.github.io.git
	  branch: master
...
　然后再浏览器中输入[http://malinghuii.github.io/](http://malinghuii.github.io/)就行了，我的 github 的账户叫 leopardpan ,把这个改成你 github 的账户名就行了
...
转载请注明原地址，潘柏信的博客：[http://malinghuii.github.io](http://malinghuii.github.io) 谢谢！
